...
public class Pose {
    ...
    public Pose(double X, double Y, double HEADING_DEG, double START_TANGENT, double END_TANGENT, double VERTICAL_OFFSET, double HORIZONTAL_OFFSET) {
        this.X = X + sin(END_TANGENT) * HORIZONTAL_OFFSET + cos(END_TANGENT) * VERTICAL_OFFSET;
        this.Y = Y - cos(END_TANGENT) * HORIZONTAL_OFFSET + sin(END_TANGENT) * VERTICAL_OFFSET;
    ...
    public Pose(double X, double Y, double HEADING_DEG, double START_TANGENT, double END_TANGENT, OFFSET offset) {
